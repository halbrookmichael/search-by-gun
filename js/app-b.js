$(document).ready(function() {
												...
												<div id="onBodyCarousel" class="carousel slide" data-touch="false" data-interval="false">
													<div class="carousel-inner">
														<div class="carousel-item active">
															<div class="on-body">
																<div class="holster-btn-container">
	...
	function addClickableAreas(carouselCards) {
		...
		for(let i = 0; i < carouselCards.length; i ++) {
			holsters += `<a class="btn btn-primary ${carouselCards[i].holsterClass}">${carouselCards[i].text}</a>`
		}
		return holsters;
	}
	function addHolsterCards(carouselCards) {
		...
		for(let i = 0; i < carouselCards.length; i ++) {
      cards += `<div class="carousel-item ${carouselCards[i].class && width >= 767 ? 
                  carouselCards[i].class : ''}">
									${currentLayout == 'mobile' ? 
	...
	function onSectionClick(elTargetClass) {
		...
		switch(elTargetClass) {
			case 'btn btn-primary chest':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn btn-primary.chest', '#onBodyCarousel', 0);
				else
					updateClickedSection('.btn btn-primary.chest', '#onBodyCarousel', 1);
				break;
			case 'btn btn-primary shoulder':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn .btn-primary.shoulder', '#onBodyCarousel', 1);
				else
					updateClickedSection('.btn.btn-primary.shoulder', '#onBodyCarousel', 2);
				break;
			case 'btn btn-primary belly':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.belly', '#onBodyCarousel', 2);
				else
					updateClickedSection('.btn.btn-primary.belly', '#onBodyCarousel', 3);
				break;
			case 'btn btn-primary appendix':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.appendix', '#onBodyCarousel', 3);
				else
					updateClickedSection('.btn.btn-primary.appendix', '#onBodyCarousel', 4);
				break;
			case 'btn btn-primary pocket':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.pocket', '#onBodyCarousel', 4);
				else
					updateClickedSection('.btn.btn-primary.pocket', '#onBodyCarousel', 5);
				break;
			case 'btn btn-primary ankle':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.ankle', '#onBodyCarousel', 5);
				else
					updateClickedSection('.btn.btn-primary.ankle', '#onBodyCarousel', 6);
				break;
			case 'btn btn-primary owb':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.owb', '#onBodyCarousel', 6);
				else
					updateClickedSection('.btn.btn-primary.owb', '#onBodyCarousel', 7);
				break;
			case 'btn btn-primary iwb':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.iwb', '#onBodyCarousel', 7);
				else
					updateClickedSection('.btn.btn-primary.iwb', '#onBodyCarousel', 8);
				break;
			case 'btn btn-primary drop-leg':
				if(currentLayout != 'mobile')
					updateClickedSection('.btn.btn-primary.drop-leg', '#onBodyCarousel', 8);
				else
					updateClickedSection('.btn.btn-primary.drop-leg', '#onBodyCarousel', 9);
				break;
